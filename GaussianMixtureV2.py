...
The code performs gaussian and gaussian-mixture on the data supplied as input.
...
plt.plot(x,y)
plt.show()
training_data = pd.read_csv('/Users/sankalpsuhastaralekar/Desktop/New_advanced/train_subset.csv')
